                        ...
                        success:function(retorno){
                            ...
                            if(retorno['resultado'] != null){
                                Swal.fire({
                                     type: 'question',
                                    title: 'CPF ja existe...',
                                    text: 'O CPF ja esta cadastrado,por favor insira outro CPF!',
                                })
...
?>
    <div class="container">
    	<section>
    		...
    		<form action="paciente-action-inserir.php" method="post" class="needs-validation" novalidate id="form">
    			<div class="form-group">
    				<label class="control-label">CPF</label>
    				<input type="text" name="cpf"  class="form-control" required="" placeholder="Digite o cpf aqui" id="cpf" minlength="11" maxlength="11" required="">
    				<div class="invalid-feedback">Por favor, informe um CPF.</div>
    				<div class="valid-feedback">Tudo certo!</div>
    			</div>
    			<div class="form-group">
    				<label class="control-label">Nome</label>
    				<input type="text" name="nome"  class="form-control" required="" placeholder="Digite o nome aqui" id="nome" minlength="3" maxlength="50" required="">
    				<div class="invalid-feedback">Por favor, informe um nome.</div>
    				<div class="valid-feedback">Tudo certo!</div>
    			</div>
    			<div class="form-group">
    				<label class="control-label">Telefone</label>
    				<input type="tel" name="telefone"  class="form-control" required="" placeholder="Digite o telefone aqui" id="telefone" minlength="10" maxlength="11" required="">
    				<div class="invalid-feedback">Por favor, informe um telefone.</div>
    				<div class="valid-feedback">Tudo certo!</div>
    			</div>
    			<div class="form-group">
    				<label class="control-label">E-mail</label>
    				<input type="email" name="email"  class="form-control" required="" placeholder="Digite o email aqui" id="email" required="" maxlength="50">
    				<div class="invalid-feedback">Por favor, informe um email.</div>
    				<div class="valid-feedback">Tudo certo!</div>
    			</div>
                 <div class="form-group">
                    <label class="control-label">CEP</label>
                    <input type="text" name="cep"  class="form-control" required="" placeholder="Digite o cep aqui" id="cep" maxlength="8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="estado" class="form-control" required=""  placeholder="Digite o estado aqui" id="estado" maxlength="50">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cidade"  class="form-control" required="" placeholder="Digite a cidade aqui" id="cidade" maxlength="50" >
                    ...
                    <input type="text" name="bairro"  class="form-control" required=""  placeholder="Digite o bairro  aqui" id="bairro" maxlength="50">
                    <div class="invalid-feedback">Por favor, informe um bairro</div>
                    <div class="valid-feedback">Tudo certo!</div>
                </div>
                 <div class="form-group">
                    <label class="control-label">Rua</label>
                    <input type="text" name="rua"  class="form-control" required=""  placeholder="Digite a rua  aqui" id="rua" maxlength="50">
                    <div class="invalid-feedback">Por favor, informe uma rua.</div>
                    <div class="valid-feedback">Tudo certo!</div>
                </div>
                <div class="form-group">
                    <label class="control-label">Numero</label>
                    <input type="text" name="numero"  class="form-control" required=""  placeholder="Digite o numero da casa aqui" id="numero" maxlength="50">
                    <div class="invalid-feedback">Por favor, informe um numero de casa.</div>
                    <div class="valid-feedback">Tudo certo!</div>
                </div>
                <div class="form-group">
                    <label class="control-label">Complemento</label>
                    <input type="text" name="complemento"  class="form-control" required=""  placeholder="Digite o complemento  aqui" id="complemento" maxlength="50">
